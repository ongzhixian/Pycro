...
class app_modules_api_stats_tests(unittest.TestCase):
    """
    python -m unittest -v tests.test_app_modules_api_stats.app_modules_api_stats_tests
    get_api_stats
    update_api_stats
    """
    ...
    def test_get_api_stats(self):
        """
        python -m unittest -v tests.test_app_modules_api_stats.app_modules_api_stats_tests.test_get_api_stats
        """
        # Arrange
    ...
    def test_update_api_stats(self):
        """
        python -m unittest -v tests.test_app_modules_api_stats.app_modules_api_stats_tests.test_update_api_stats
        """
        # Arrange
    ...
    def test_have_api_stats(self):
        """
        python -m unittest -v tests.test_app_modules_api_stats.app_modules_api_stats_tests.test_have_api_stats
        """
        # Arrange
